...
async function processLineByLine() {	
  const fileStream = fs.createReadStream(PATH_OUT + '/helloworld.txt');	
  ...
  console.log(json);	
  return fs.writeFile(PATH_OUT + '/helloworld.json', JSON.stringify(json, null, 2), 'utf8', () => {
    console.log(PATH_OUT + '/helloworld.json');
  });
}
